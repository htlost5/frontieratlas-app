...
const LIGHT_TOKENS: ColorTokens = {
  ...
  rooms: {
    ...
    amber: { fill: "#E6D860", line: "#D4C030", circleFill: "#B09000" },
    aqua: { fill: "#81D4FA", line: "#4FC3F7", circleFill: "#0288D1" },
    ...
    gold: { fill: "#B8A820", line: "#9A9018", circleFill: "#7A6000" },
...
const DARK_TOKENS: ColorTokens = {
  ...
  rooms: {
    ...
    amber: { fill: "#4A4200", line: "#6A5C00", circleFill: "#8A7A00" },
    aqua: { fill: "#002B3A", line: "#003D4F", circleFill: "#006064" },
    ...
    gold: { fill: "#3D3018", line: "#5D4820", circleFill: "#5D4820" },
